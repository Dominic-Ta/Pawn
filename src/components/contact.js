...
import { address as adr} from '../constant_vales/landing';
    ...
    return (
        <>
            <div className="section-title">
                <h2>Contact</h2>
                <p>Send a message! We're always here to help.</p>
            </div>
                    ...
                    <div className="info-wrap">
                        <div className="row">
                            <div className="col-lg-4 info">
                                <a href={adr[0].map} target="_blank" rel="noopener noreferrer nofollow" ><i className="bi bi-geo-alt"></i></a>
                                <h4>Location:</h4>
                                <p>{adr[0].address}</p>
                            </div>
